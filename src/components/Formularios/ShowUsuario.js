      ...
      <animated.section style={educationProps} className="education-section py-5 bg-light">
        <Container>
          ...
          <Row className="mb-5">
            ...
            <Col md={4} className="mb-4">
              <Card className="p-4 shadow-sm">
                <h4>Programa de Capacitación sobre Ciberseguridad<br /><br /></h4>
                <p className="text-muted">Superintendencia de Bancos</p>
                <p className="text-muted">2025</p>
                <Button color="primary" size="sm" onClick={() => openModal(logo17)}>
                  Ver Certificado
                </Button>
              </Card>
            </Col>
            <Col md={4} className="mb-4">
              <Card className="p-4 shadow-sm">
                <h4>AWS Security Incident Response - Ransomware Use Case<br /><br /></h4>
                <p className="text-muted">AWS training certification</p>
                <p className="text-muted">2025</p>
                <Button color="primary" size="sm" onClick={() => openModal(logo16)}>
                  Ver Certificado
                </Button>
              </Card>
            </Col>
